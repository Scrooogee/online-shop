    ...
    return ( <header className='header'>
        <Link to='/'>
            <div className='header__logo-box'>
                ...
                <div>
                    <h3 className='header__titel'>best sneakers</h3>
                    <p className='header__subtitel'>The best sneakers shop</p>
                </div>
            </div>
        </Link>
        <div>
            <ul className='header__list'>
                <li onClick={onCLickCart} className='header__list-item'>
                    ...
                    ${items.length === 0 ? 0 : items.reduce((acc, item) => acc += +item.price, 0)}
                </li>
